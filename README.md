...
<p>To deal with this, we can either find more images and add them to the dataset or augment the original images to <a href="https://towardsdatascience.com/complete-image-augmentation-in-opencv-31a6b02694f5">generate synthetic images</a>. However, I couldn't find more images. Therefore, I have used different augmentation techniques to create fake images. In particular, I have augmented the original images by adjusting their hue, brightness, saturation, red, green, blue intensities and applying the <a href="https://docs.opencv.org/3.4/da/d54/group__imgproc__transform.html#ga0203d9ee5fcd28d40dbc4a1ea4451983">affine transformation</a> with different rotation angles.</p> 
...
<table>
 <center>
  ...
  <tr>
     <td> <img src="./test_images/fm_conv2_label_13.png" width="1000" height="240"> </td>
  </tr>
   <tr>
  ...
  <tr>
     <td> <img src="./test_images/fm_conv2_label_36.png" width="1000" height="240"> </td>
  </tr>
   <tr>
  ...
  <tr>
     <td> <img src="./test_images/fm_conv2_label_26.png" width="1000" height="240"> </td>
  </tr>
   <tr>
